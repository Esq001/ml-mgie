...
enum DocumentType: String, Codable, CaseIterable {
    ...
    var displayName: String {
        ...
        case .supportingDoc: return "Supporting Doc"
    ...
    var icon: String {
        ...
        case .workPaper: return "tablecells.fill"
        case .schedule: return "list.clipboard.fill"
        case .supportingDoc: return "paperclip"
...
struct TaxDocument: Codable, Identifiable, Hashable {
    ...
    static func == (lhs: TaxDocument, rhs: TaxDocument) -> Bool { lhs.id == rhs.id }
...
struct ReviewResult: Codable, Identifiable {
    ...
    var unresolvedIssueCount: Int { issues.filter { !$0.resolved }.count }
    var highSeverityCount: Int { issues.filter { $0.severity == .high && !$0.resolved }.count }
}
